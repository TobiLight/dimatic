...
<div class="pt-8">
	...
	<div class="sect-3 grid sm:grid-cols-2 items-center gap-x-10 gap-y-20 mt-20">
		<img src={Hof1} alt="Blog 1" class="w-[100%] h-full mx-auto" />
		<img src={Hof2} alt="Blog 1" class="w-[100%] h-full mx-auto" />
		<img src={Hof3} alt="Blog 1" class="w-[100%] h-full mx-auto" />
		<img src={Hof4} alt="Blog 1" class="w-[100%] h-full mx-auto" />
		<img src={Hof5} alt="Blog 1" class="w-[100%] h-full mx-auto" />
		<img src={Hof6} alt="Blog 1" class="w-[100%] h-full mx-auto" />
		<img src={Hof7} alt="Blog 1" class="w-[100%] h-full mx-auto" />
		<img src={Hof8} alt="Blog 1" class="w-[100%] h-full mx-auto" />
	</div>
	...
	<div class="sect-6 grid gap-y-8">
		<img src={Testim} alt="Daily mail" class="w-[80%] sm:w-[60%] h-full mx-auto" />
		<a href="/" class="book-call">BOOK 7MIN INTRO CALL</a>
	</div>
</div>
